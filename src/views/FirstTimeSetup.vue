      ...
      >
        ...
        <b-form class="mt-5">
          ...
          <b-form-group
            ...
            description="You can not change this later!"
          >
            <b-form-select
              required
              :options="sports"
              v-model="user.sportType"
            >
            </b-form-select>
          </b-form-group>
          <b-form-group class="text-right">
            <b-button
              @click="currentPage++"
              variant="success"
              :disabled="!(user.sportType && user.firstName && user.lastName)"
            >Next <i class="fas fa-chevron-right"></i></b-button>
          </b-form-group>
        </b-form>
      </div>
      <div
        ...
        <b-form class="mt-5">
          ...
          <div class="d-flex justify-content-between mt-3">
            ...
            <b-button
              @click="submitSetup"
              variant="success"
              :disabled="!(team.name.length >= 4 && user.sportType && user.firstName && user.lastName)"
